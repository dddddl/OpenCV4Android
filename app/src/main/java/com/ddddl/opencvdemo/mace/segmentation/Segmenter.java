...
import com.ddddl.opencvdemo.mace.common.AppConfig;
...
public class Segmenter {
    ...
    public class Segmentation {
        ...
        public Segmentation(final Bitmap segBitmap,final Bitmap backgroundBitmap, final String[] labels,
    ...
    public Segmentation segment(Bitmap bitmap) {
        ...
        return new Segmentation(segResult.segBitmap,segResult.backgroundBitmap, labels,
