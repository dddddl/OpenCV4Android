...
public class MaskProcessor {
    ...
    public MaskProcessor(final AssetManager assetManager,
        ...
        this.colors[1] = Color.argb(255, 255, 255, 255);
    ...
    public Result process(int inputHeight, int inputWidth,
        ...
        int[] backPixels = new int[inputHeight * inputWidth];
        for (int hIdx = 0; hIdx < inputHeight; ++hIdx) {
            for (int wIdx = 0; wIdx < inputWidth; ++wIdx) {
                ...
                backPixels[hIdx * inputWidth + wIdx] = this.colors[1 - classValue];
        ...
        result.backgroundBitmap = Bitmap.createBitmap(inputWidth, inputHeight, Bitmap.Config.ARGB_8888);
        result.backgroundBitmap.setPixels(backPixels, 0, inputWidth,
                0, 0, inputWidth, inputHeight);
